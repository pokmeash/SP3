 ...
 */
void SpaceFly::Update(const double dElapsedTime)
{
	if (!bIsActive)
		return;
	...
	case DAMAGED:
		...
		if (spikecollided && iFSMCounter > iMaxFSMCounter)
		{
			...
			spikecollided = false;
 			...
 			if (enemyhealth < 3 && healedonce == false)
			{
				sCurrentFSM = HEALING;
			}
...
*/
void SpaceFly::Seti32vec2Index(const int iIndex_XAxis, const int iIndex_YAxis)
{
...
*/
void SpaceFly::Seti32vec2NumMicroSteps(const int iNumMicroSteps_XAxis, const int iNumMicroSteps_YAxis)
{
 ...
 */
void SpaceFly::SetPlayer2D(CPlayer2D* cPlayer2D)
{
...
*/
bool SpaceFly::LoadTexture(const char* filename, GLuint& iTextureID)
{
 ...
 */
void SpaceFly::Constraint(DIRECTION eDirection)
{
	if (eDirection == LEFT)
	{
		if (i32vec2Index.x < 0)
	...
	{
		cout << "SpaceFly::Constraint: Unknown direction." << endl;
	}
}
...
/**
 ...
 @param eDirection A DIRECTION enumerated data type which indicates the direction to check
 */
bool SpaceFly::CheckPosition(DIRECTION eDirection)
{
	if (eDirection == LEFT)
	{
	...
	{
		cout << "SpaceFly::CheckPosition: Unknown direction." << endl;
	}
...
// Update Jump or Fall
void SpaceFly::UpdateJumpFall(const double dElapsedTime)
{
 ...
 */
bool SpaceFly::InteractWithPlayer(void)
{
 ...
 */
void SpaceFly::UpdateDirection(void)
{
 ...
 */
void SpaceFly::FlipHorizontalDirection(void)
{
...
*/
void SpaceFly::UpdatePosition(void)
{
