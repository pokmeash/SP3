...
public:
	...
	void SetGravity(const glm::vec2 v2Gravity);		// Set Gravity Direction (Actual Number)
	...
	glm::vec2 GetGravity(void) const;			// Get Gravity Direction (Actual Number)
...
protected:
	...
	glm::vec2 v2Gravity;			// Gravity no longer constant
	float fTime;					// Time
