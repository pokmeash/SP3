...
// Set Displacement
void CPhysics2D::SetGravity(const glm::vec2 v2Gravity)
{
	this->v2Gravity = v2Gravity;				// Gravity
}
...
// Get Gravity
glm::vec2 CPhysics2D::GetGravity(void) const
{
	return v2Gravity;			// Gravity
}
